CLASS zcl_rap100_gen_data_zvz DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_zvz IMPLEMENTATION.
...
*   clear data
    DELETE FROM zrap100_atravzvz.
*    DELETE FROM zrap100_dtravzvz.

    "insert travel demo data
    INSERT zrap100_atravzvz  FROM (
        SELECT
